...
class TestBoggle(unittest.TestCase):
    ...
    def test_converting_a_path_to_a_word(self):
        ...
        twoLetterWord = boggle.path_to_word(grid, [(0, 0), (0, 1)])
        self.assertEqual(oneLetterWord, grid[(0,0)])
        self.assertEqual(twoLetterWord, grid[(0, 0)] + grid[(0,1)])
        
    def test_search_grid_for_words(self):
        """
        Ensure that certain patterns can be found in a path to word
        """
